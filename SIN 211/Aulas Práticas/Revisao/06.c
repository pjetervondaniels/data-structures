...
/*
Codifique, compile e execute um programa em C que contenha um cadastro de produtos de
um estoque. Cada produto possui as seguintes informações:
...
(a) Defina uma estrutura em C, denominada produto, que tenha os campos apropriados
